          ...
          <div class="col-12">  
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <a class="btn btn-app" href="<?=site_url()?>/Medicamentos/nuevo">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>
                      <div class="btn-group">
                        <button type="button" class="btn btn-default" onclick="window.location.href='<?=site_url()?>/Medicamentos/modificar/<?=$med->idMedicamento;?>'"><i class="fas fa-edit"></i></button>
                      </div>
                    </td>
