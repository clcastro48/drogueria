          ...
          <div class="col-12">  
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <a class="btn btn-app" href="<?=site_url()?>/Clientes/nuevo">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>
                      <div class="btn-group">
                        <button type="button" class="btn btn-default" onclick="window.location.href='<?=site_url()?>/Clientes/modificar/<?=$c->idCliente;?>'"><i class="fas fa-edit"></i></button>
                      </div>
                    </td>
                    <td><?=$c->tipo_identificacion;?></td>
                    <td><?=$c->n_identificacion;?></td>
                    <td>
                      <?=$c->nombre_comp;?>
                    </td>
                    <td><?=$c->telefono;?></td>
