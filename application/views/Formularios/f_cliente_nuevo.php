        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" action="<?=site_url()?>/Clientes/nuevo/guardar" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom_comp">Nombre Completo</label>
                    <input type="text" name="nom_comp" class="form-control" id="nom_comp" placeholder="Ingrese nombre completo"  required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="n_id" class="form-control" id="n_id" placeholder="Ingrese número" maxlength='15' required>
                  </div>
                  <div class="form-group">
                    <label for="tel">Telefono</label>
                    <input type="number" name="tel" class="form-control" id="password" placeholder="Ingrese número" min="0" minlength="10" maxlength='10'>
                  </div>
                </div>
                <!-- /.card-body -->
