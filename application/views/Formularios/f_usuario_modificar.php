        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" action="<?=site_url()?>/Usuarios/modificar/<?=$usr[0]->idUsuario;?>/guardar" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom_comp">Nombre Completo</label>
                    <input type="text" name="nom_comp" class="form-control" id="nom_comp" placeholder="Ingrese nombre completo" value="<?=$usr[0]->nombre_comp;?>" <?php if($usr[0]->nombre_comp==="Administrador"){ ?> disabled <?php } ?>>
                  </div>
                  <div class="form-group">
                    <label for="cedula">Cedula</label>
                    <input class="form-control" id="cedula" value="<?=$usr[0]->cedula;?>" disabled>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="estado" id="estado">
                      <option <?php if($usr[0]->estado==="Activo"){ ?> selected <?php } ?> >Activo</option>
                      <option <?php if($usr[0]->estado==="Inactivo"){ ?> selected <?php } ?> >Inactivo</option>
                    </select>
                  </div>
                  <?php
                    }
  ...
  $('#quickForm').validate({
    ...
    messages: {
      ...
      password: {
        ...
        minlength: "Su password debe ser minimo de 8 caracteres"
      }
    },
    errorElement: 'span',
