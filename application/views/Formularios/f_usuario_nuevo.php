        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" action="<?=site_url()?>/Usuarios/nuevo/guardar" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nom_comp">Nombre Completo</label>
                    <input type="text" name="nom_comp" class="form-control" id="nom_comp" placeholder="Ingrese nombre completo">
                  </div>
                  <div class="form-group">
                    <label for="cedula">Cedula</label>
                    <input type="number" name="cedula" class="form-control" id="cedula" placeholder="Ingrese número">
                  </div>
                  <div class="form-group">
  ...
  $('#quickForm').validate({
    ...
    messages: {
      ...
      cedula: {
        ...
        minlength: "El número de cedula debe contener menos de 12 digitos",
        number: "Por favor ingrese número"
      },
      password: {
